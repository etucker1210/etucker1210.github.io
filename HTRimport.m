function RotationData = HTRimport(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   TRIMMEDBAS0920150501TRIAL04 = IMPORTFILE(FILENAME) Reads data from text
%   file FILENAME for the default selection.
%
%   TRIMMEDBAS0920150501TRIAL04 = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   TrimmedBas0920150501Trial04 = importfile('Trimmed_Bas09_2015-05-01_Trial04.htr', 65, 6004);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/01/18 15:12:57
...
RotationData = cell2mat(raw);
RotationData(:,2:4)=[];
RotationData(:,5)=[];
nanloc=find(RotationData(:,2)==-81);
RotationData(nanloc,2:4) = NaN;
