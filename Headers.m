function Headers= Headers(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   TRIMMEDBAS0920150501TRIAL06 = IMPORTFILE(FILENAME) Reads data from text
%   file FILENAME for the default selection.
%
%   TRIMMEDBAS0920150501TRIAL06 = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   TrimmedBas0920150501Trial06 = importfile('Trimmed_Bas09_2015-05-01_Trial06.htr', 65, 65);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/01/18 15:50:57
